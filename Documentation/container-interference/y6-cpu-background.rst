...
An explicitly selected set of at most eight online CPUs is observed for at
most the existing bounded specialist window. Native scheduler, IRQ, softirq
...
Execution intervals have matching switch endpoints. IRQ/softirq intervals are
stack-paired per CPU; their union is subtracted once from task execution.
