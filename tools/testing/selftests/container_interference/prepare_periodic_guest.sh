...
cp "$source/tools/container_interference/bpf/"{ip,owner,sched,reclaim,sync,fd,counter,allocator,alloc_backend,net,block,rwsem,slub}.bpf.o "$dest/root/profile/"
