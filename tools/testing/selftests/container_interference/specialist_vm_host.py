...
def run(args):
    ...
    if args.label in ('x4-net','x4-backlog','x4-net-rights','x4-net-origin','x7-mixed','x4-net-capacity','x4-net-txfailure','x4-net-txadmission','x4-net-guard'):
