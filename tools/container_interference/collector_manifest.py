...
COLLECTORS = {
    ...
    'owner': dict(profile=2, programs=['owner_state', 'owner_switch'],
                  ...
                  object_kinds=['mutex', 'lockref', 'files_struct_lock_requires_CONFIG_CIS_OBSERVE_FD'],
                  source_filter='target attempt opens bounded object watch; registered holder universe; FD/lockref prefix 64 events'),
