...
int cis_capture_prepare(struct cis_context *, const char *);
int cis_capture_arm(struct cis_context *, uint64_t, uint64_t);
int cis_capture_inventory(struct cis_context *, char *, size_t);
int cis_capture_quiesce(struct cis_context *);
